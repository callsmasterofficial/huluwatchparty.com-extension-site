  ...
  return (
    <div className="footer-container mt-[20%] w-screen md:mt-[10%]">
      ...
      <div className="btn-box m-10 flex w-auto items-center justify-center border-b-2 border-white">
        ...
        <button className="mb-5 -mt-6 flex w-auto items-center justify-center rounded-[4px] bg-white p-2 text-xl transition-all  duration-200 hover:bg-gray-600 md:mt-0 ">
        ...
        {/* privacty button */}
        <Link href="/privacy">
          <div className="privacyBtnBox mb-5 -mt-6 ml-4 flex items-center justify-center rounded-[4px] bg-white p-2 text-xl  transition-all duration-200 hover:bg-gray-600 md:mt-0">
      ...
      <div className="popu_search_container m-auto mb-4 w-[90%] ">
